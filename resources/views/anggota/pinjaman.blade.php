...
@section('content')
    <div class="page-content">
        ...
        <div style="vertical-align: bottom" class="d-flex justify-content-between">
            ...
            <div>
                <button @if (count($d) > 0) disabled @endif type="button" class="btn btn-sm btn-primary"
                    data-bs-toggle="modal" data-bs-target="#exampleLargeModal" class="btn btn-sm btn-success">Pengajuan
