...
@section('content')
    <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <div class="breadcrumb-title pe-3">Data Pengajuan Penarikan</div>
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        <li class="breadcrumb-item"><a href="javascript:;"><i class="bx bx-home-alt"></i></a>
                        </li>
                        <li class="breadcrumb-item active" aria-current="page">Data Penarikan Anggota</li>
                    </ol>
                </nav>
            </div>
        ...
        <div style="vertical-align: bottom" class="d-flex justify-content-between">
            <h6 class="mb-0 text-uppercase">Manajemen Data Pengajuan Simpanan </h6>
    ...
    <script>
        jQuery(document).ready(function() {
            ...
            tabel = $("#example").DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ url('/admin/data-pengajuan/penarikan') }}",
                },
                columns: [{
                        nama: 'DT_RowIndex',
                        data: 'DT_RowIndex'
        ...
        function staffdel(id) {
            ...
            if (data) {
                ...
                $.ajax({
                    url: url + '/admin/data-simpanan/' + id,
                    type: "delete",
                    success: function(e) {
                        $.LoadingOverlay("hide");
                        if (e == 'success') {
        ...
        function staffterima(id) {
            ...
            if (data) {
                ...
                $.ajax({
                    url: url + '/admin/data-pengajuan/t/terima/' + id,
                    type: "post",
                    success: function(e) {
                        $.LoadingOverlay("hide");
                        if (e == 'success') {
