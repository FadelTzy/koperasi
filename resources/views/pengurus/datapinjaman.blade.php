...
@section('content')
    <div class="page-content">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form id="tambahdata" class=" form-horizontal form-bordered">
                            ...
                            <div class="input-group">
                                <input type="number" name="maksimal" placeholder="Input maksimal" class="form-control" />
                            ...
                            <div class="input-group">
                                <input type="number" name="bunga" placeholder="Input bunga" class="form-control" />
                            ...
                            <div class="input-group">
                                <input type="number" name="angsur" placeholder="Input angsur" class="form-control" />
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form id="editdata" class=" form-horizontal form-bordered">
                            ...
                            <div class="input-group">
                                <input type="number" id="maksimalu" name="maksimal" placeholder="Input Maksimal"
                                    class="form-control" />
                            ...
                            <label class="form-label">Bunga Pinjaman (%)</label>
                            <div class="input-group">
                                <input type="number" id="bungau" name="bunga" placeholder="Input bunga"
                                    class="form-control" />
                            ...
                            <label class="form-label">Lama Angsuran (Bulan)</label>
                            <div class="input-group">
                                <input type="number" id="angsuru" name="angsur" placeholder="Input angsur"
                                    class="form-control" />
        ...
        <div style="vertical-align: bottom" class="d-flex justify-content-between">
            <h6 class="mb-0 text-uppercase">Manajemen Data Pinjaman </h6>
...
@push('js')
    ...
    <script>
        ...
        function staffupd(id) {
            ...
            $("#idu").val(id.id);
            $("#maksimalu").val(id.maksimal);

            $("#namau").val(id.nama);
            $("#angsuru").val(id.angsur);
            $("#bungau").val(id.bunga);
