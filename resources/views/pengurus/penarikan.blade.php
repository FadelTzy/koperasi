    ...
    <div class="page-content">
        ...
        <div style="vertical-align: bottom" class="d-flex justify-content-between">
            ...
            <div>
                ...
                <a href="{{ url('admin/tabungan/') }}" type="button" class="btn btn-sm btn-success"
                    class="btn btn-sm btn-success">Kembali </a>
            </div>
        </div>
    ...
    <script>
        jQuery(document).ready(function() {
            ...
            tabel = $("#example").DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ url('admin/tabungan/penarikan') . '/' . Request::segment(4) }}",
                },
