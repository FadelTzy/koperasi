...
@section('content')
    <div class="page-content">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form id="tambahdata" class=" form-horizontal form-bordered">
                            ...
                            <div class="input-group">
                                <input type="text" name="pokok" value="{{ $dp->jumlah ?? 0 }}"
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form id="editdata" class=" form-horizontal form-bordered">
                            ...
                            <label class="form-label">Simpanan Pokok</label>
                            <div class="input-group">
                                <input type="text" name="pokok" value="{{ $dp->jumlah ?? 0 }}" id="pokoku"
                                    disabled placeholder="Input pokok" class="form-control" />
        ...
        <div style="vertical-align: bottom" class="d-flex justify-content-between">
            <h6 class="mb-0 text-uppercase">Manajemen Data Anggota </h6>
