...
@section('content')
    <div class="page-content">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form id="tambahdata" class=" form-horizontal form-bordered">
                            ...
                            <div class="input-group">
                                <input type="text" name="pokok" value="{{ $dp->jumlah }}" placeholder="Input pokok"
                                    class="form-control" />
                            ...
                            <div class="input-group">
                                <input type="text" name="pekerjaan" placeholder="Input pekerjaan" class="form-control" />
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form id="editdata" class=" form-horizontal form-bordered">
                            ...
                            <label class="form-label">Simpanan Pokok</label>
                            <div class="input-group">
                                <input type="text" name="pokok" value="{{ $dp->jumlah }}" id="pokoku" disabled
                                    placeholder="Input pokok" class="form-control" />
                            ...
                            <label class="form-label">Pekerjaan</label>
                            <div class="input-group">
                                <input type="text" id="pekerjaanu" name="pekerjaan" placeholder="Input Pekerjaan"
                                    class="form-control" />
                            ...
                            <label class="form-label">Nomor </label>
                            <div class="input-group">
                                <input type="text" id="nou" name="no" placeholder="Input Nomor"
                                    class="form-control" />
                            </div><!-- input-group -->
                            <br>
                            ...
                            <label class="form-label">Alamat </label>
                            <div class="input-group">
                                <input type="text" name="alamat" placeholder="Input alamat" id="alamatu"
                                    class="form-control" />
                            </div><!-- input-group -->
                            <br>
                            <label class="form-label">Jenis Kelamin </label>
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="jku" id="inlineRadio1u"
                                    value="1">
                                <label class="form-check-label" for="inlineRadio1">Laki - Laki</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="jku" id="inlineRadio2u"
                                    value="0">
                                <label class="form-check-label" for="inlineRadio2">Perempuan</label>
                            </div>
                            <br>
        ...
        <div style="vertical-align: bottom" class="d-flex justify-content-between">
            <h6 class="mb-0 text-uppercase"> Data Tabungan Anggota </h6>
            @if (Auth::user()->role == 1 || Auth::user()->role == 2)
                <a target="_blank" type="button" href="{{ url('admin/tabungan/cetak') }}"
                    class="btn btn-sm btn-primary" class="btn btn-sm btn-success">Print <i
    ...
    <script>
        ...
        function staffkel(id) {
            ...
            if (data) {
                ...
                $.ajax({
                    url: url + '/admin/anggota/keluar/' + id,
                    type: "delete",
                    success: function(e) {
                        $.LoadingOverlay("hide");
                        if (e == 'success') {
        ...
        function staffaktif(id) {
            ...
            if (data) {
                ...
                $.ajax({
                    url: url + '/admin/anggota/aktif/' + id,
                    type: "delete",
                    success: function(e) {
                        $.LoadingOverlay("hide");
                        if (e == 'success') {
        ...
        function staffupd(id) {
            ...
            $("#emailu").val(id.email);
            if (id.detail != null) {
                $("#pekerjaanu").val(id.detail.pekerjaan ?? '-');

                $("#nou").val(id.detail.nohp ?? '-');
                $("#alamatu").val(id.detail.alamat ?? '-');
            }
            $("#kodeu").val(id.kode);
            var $radios = $('input:radio[name=jku]');
            if ($radios.is(':checked') === false) {
                $radios.filter('[value=' + id.jk + ']').prop('checked', true);
            }
