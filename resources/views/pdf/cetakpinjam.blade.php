    ...
    <table class="p">
        <tbody>
            <tr class="">
                ...
                <th class="text-center" style="width:5%; text-align:center">Kode Pinjaman</th>
                <th class="text-center" style="width:5%; text-align:center">Peminjam</th>

                <th class="text-center" style="width:5%; text-align:center">Tgl Pengajuan</th>
                <th class="text-center" style="width:5%; text-align:center">Nama Pinjaman</th>
                <th class="text-center" style="width:5%; text-align:center">Jumlah </th>
                <th class="text-center" style="width:5%; text-align:center">Angsuran</th>
                <th class="text-center" style="width:5%; text-align:center">Bunga </th>
                <th class="text-center" style="width:5%; text-align:center">Biaya Angsuran </th>
                <th class="text-center" style="width:5%; text-align:center">Status Pengajuan</th>
                <th class="text-center" style="width:5%; text-align:center">Status Pinjaman</th>
