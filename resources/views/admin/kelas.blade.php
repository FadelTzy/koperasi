                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form id="tambahdata" class=" form-horizontal form-bordered">
                            ...
                            <br>
                            <label class="form-label">Ketua Tingkat </label>
                            <div class="input-group">
                                <select style="z-index: 999" name="keti" class="form-control ">
                                    <option selected disabled>Pilih Ketua Tingkat</option>
                                    @foreach ($mahasiswa as $jk)
                                        <option value="{{ $jk->no_identitas }}">{{ $jk->name }}</option>
                                    @endforeach
                                </select>
                            </div><!-- input-group -->
                            <br>
                            ...
                            <div class="input-group">
                                <input type="text" name="jumlah" placeholder="Input Jumlah Mahasiswa"
                                    class="form-control" />
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form id="editdata" class=" form-horizontal form-bordered">
                            ...
                            <label class="form-label">Ketua Tingkat </label>
                            <div class="input-group">
                                <select id="ketiu" style="z-index: 999" name="keti" class="form-control ">
                                    <option selected disabled>Pilih Ketua Tingkat</option>
                                    @foreach ($mahasiswa as $jk)
                                        <option value="{{ $jk->no_identitas }}">{{ $jk->name }}</option>
                                    @endforeach
                            ...
                            <label class="form-label">Jumlah Mahasiswa</label>
                            <div class="input-group">
                                <input type="text" id="jumlahu" name="jumlah" placeholder="Input Jumlah Mahasiswa"
                                    class="form-control" />
...
@push('js')
    ...
    <script>
        ...
        function staffupd(id) {
            ...
            $("#jumlahu").val(id.jumlah_mahasiswa);

            $('#ketiu option[value=' + id.id_keti + ']').attr('selected', 'selected');
